...
<tr>
  <td>
    ...
    <input class="form-control" name="email_label" value="" hx-post="/components/customer-addresses/line1.php" hx-trigger="keyup changed delay:500ms" hx-include="previous input">
  </td>
  <td>
    <input type="hidden" name="address_id" value="<?php echo htmlspecialchars($row["id"]) ?>">
    <input class="form-control" name="email_label" value="" hx-post="/components/customer-addresses/line1.php" hx-trigger="keyup changed delay:500ms" hx-include="previous input">
